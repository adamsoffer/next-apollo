...
export default (apolloConfig, ComposedComponent) => {
  return class WithData extends React.Component {
    ...
    static async getInitialProps(ctx) {
      ...
      if (!process.browser) {
        const apollo = initApollo(apolloConfig.options)
        const redux = initRedux(apollo, apolloConfig.reducers)
    ...
    constructor(props) {
      super(props)
      this.apollo = initApollo(apolloConfig.options)
      this.redux = initRedux(
        this.apollo,
        apolloConfig.reducers,
